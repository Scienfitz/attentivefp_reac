...
def parse_arguments():
    ...
    parser.add_argument('--split_column', dest='split_column', help='Column with splitting data. Only relevant for split types "GroupKFold" and "Predefined"', action='store', required=False)
